...
public class ViewSystemUsersPage extends Utility {
    ...
    {
        waitAndClick(userRoleField);
        selectByVisibleTextFromDropDown(userRoleField, "Admin");
    }

    public void enterEmployeeName() {
        sendTextToElement(employeeNameField, "Kiara Parikh");
    }

    public void selectFromDropDownStatus() {
        waitAndClick(statusField);
        selectByVisibleTextFromDropDown(statusField, "Enable");
    }
    ...
    public String verifyResultListText() {
